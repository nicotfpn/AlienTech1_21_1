...
public class PyramidCoreHud {
    ...
    public static void renderHud(GuiGraphics guiGraphics, float partialTick) {
        ...
        if (!(level.getBlockState(pos).getBlock() instanceof PyramidCoreBlock))
            return;
    ...
    private static void renderPyramidCoreHud(GuiGraphics guiGraphics, Minecraft mc,
        ...
        guiGraphics.fill(x - 5, y - 5, x + HUD_WIDTH + 5, y - 3, borderColor);
        guiGraphics.fill(x - 5, y + HUD_HEIGHT + 3, x + HUD_WIDTH + 5, y + HUD_HEIGHT + 5, borderColor);
        guiGraphics.fill(x - 5, y - 3, x - 3, y + HUD_HEIGHT + 3, borderColor);
        guiGraphics.fill(x + HUD_WIDTH + 3, y - 3, x + HUD_WIDTH + 5, y + HUD_HEIGHT + 3, borderColor);
